...
import { View, Text, TextInput, Dimensions, TouchableWithoutFeedback, Keyboard, TouchableOpacity} from 'react-native'
import { ScaledSheet } from 'react-native-size-matters'
import { useFonts } from 'expo-font'
import Poppins from '../assets/fonts/Poppins-Light.ttf'
import HeaderFlag from '../style/HeaderFlag'

export default function ForgetPassWorld3({navigation}) {
        ...
        <TouchableWithoutFeedback onPress={() => {
            ...
            <View>
                ...
                <View style={[styles.conatiner, {height : height-50, width : width}]}>
                    <Text style={styles.first}>Change password</Text>
