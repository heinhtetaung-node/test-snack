...
import EducationHeader from '../style/EducationHeader'
import { Feather } from '@expo/vector-icons'
import TopApp from '../style/HomeTop'

// School Type picker select list
const school = [
...
// Major picker select list

const major = [
    { label: 'Eco', value: 'Eco' },
    { label: 'English major', value: 'English major' },
...
// Graudation picker select list

const status = [
    { label: 'Pass', value: 'Pass' },
    { label: 'Honours', value: 'Honours' },
    { label: 'Expected to Graduate', value: 'Expected to Graduate' }
];

const statusPlace = {
    label: 'Graudation status',
    value: null,
    color: '#9EA0A4',
}
